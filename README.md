...
* **Sensors:** An RFID reader was employed as the sole sensor, leveraging the existing RFID tags embedded in the student and faculty IDs for user authentication and access control.
